...
import CustomizedStepper from "./CustomizedStepperMuseum";
...
function BuyTickets(props: MuseumProps) {
                ...
                >
                  ...
                  >
                    <h5
                      ...
                      style={{ color: "#00A3A3" }}
                    >
                      {adultAmount} x Individual Ticket (Adult) for the  museum {props.mProps.museumName}
                    </h5>
                    <h6
                  ...
                  >
                    ...
                    >
                      ...
                      museum {props.mProps.museumName}
                    </h5>
                    <h6
                      className="pl-3 pr-3 pt-1 pb-1"
                      style={{ color: "#47525E" }}
